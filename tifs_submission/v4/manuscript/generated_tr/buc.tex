...
\caption{Dürüst fayda kaybı (BUC, yüzde puan): savunmasız düz ortalamanın son tur doğruluğu eksi savunmanınki; Tablo~\ref{tab:ber} ile aynı saldırgansız koşumlar. Pozitif değerler düz ortalamadan daha düşük son doğruluğu gösterir.}\label{tab:buc}
\resizebox{\textwidth}{!}{%
...
\vspace{2pt}\parbox{\linewidth}{\scriptsize Üç tohum üzerinden betimsel ortalamalar. Tohum başına eşleştirilmiş farklar yapıt dosyalarında, özet aralıklar ek belgede verilmiştir. Hiçbir tekil değere anlamlılık iddiası eklenmemiştir.}
\end{table*}
