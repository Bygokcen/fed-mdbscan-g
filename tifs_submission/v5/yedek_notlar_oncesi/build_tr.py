...
TABLES = {
    "ablation": dict(
        ...
        notes=r"Eşleşen ablasyon bloğu. Aralıklar koşullar arasındaki değişkenliği gösterir, güven aralığı değildir. 1. aşama kabul bölgesinin üzerindeki bütün katmanları kaldırmak ortalamayı yüzde puanın onda birinden az değiştirir. Hücreler üç tohum üzerinden veri kümesi~$\times$~koşul ortalamalarıdır; küçük bir ortalama farktan eşdeğerlik sonucu çıkarılmamaktadır.",
    ...
    "alarm": dict(
        ...
        notes=r"Fed-MDBSCAN-G, değerlendirilen kurallar içinde tur düzeyinde alarm üreten tek kuraldır. Payda saldırgansız turlardır; $\alpha=0.01$ iken her veri kümesinde her tur alarm üretir. Bu sayımlar temiz kontrollerdeki yanlış alarmları ölçer; belirli bir saldırı sıklığındaki öngörü değerini ölçmez. Diğer kurallarda alarm kanalı yoktur. Alarm mekanizmasının yokluğu alarm özgüllüğü anlamına gelmediği için bu kurallara sıfır oran yazılmamıştır.",
    ...
    "discrimination_method": dict(
        ...
        notes=r"Mevcut hücreler üzerinden ortalamalar; sütunlar Tablo~\ref{tab:discrimination} ile aynıdır. FLTrust bu panelde kısıtlı ailede pozitif ortalama $J$ elde eder; sayımları sıfır ağırlıklara ilişkindir. Bu, savunma sınıfları arasında genel bir ayrım kanıtlamaz.",
    ...
    "flame_sizes": dict(
        ...
        notes=r"Saldırgansız ana hücrelerde kaydedilmiş kabul kimliklerinden sayılmıştır; her satır üç tohum ve 90 tur içerir. Boyut 46 sütunu, izin verilen en küçük boyuttaki turları sayar. Dondurulmuş normal yol gürültü olmayan tek bir kümeyi tutar; geçmiş küme etiketleri kaydedilmemiştir. En küçük boyuta 719/990 turda ulaşılır. Sayımlar BER değerinden geri hesaplanmamıştır.",
