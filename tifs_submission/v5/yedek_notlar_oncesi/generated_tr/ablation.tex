...
\par\vspace{3pt}\parbox{\linewidth}{\footnotesize Eşleşen ablasyon bloğu. Aralıklar koşullar arasındaki değişkenliği gösterir, güven aralığı değildir. 1. aşama kabul bölgesinin üzerindeki bütün katmanları kaldırmak ortalamayı yüzde puanın onda birinden az değiştirir. Hücreler üç tohum üzerinden veri kümesi~$\times$~koşul ortalamalarıdır; küçük bir ortalama farktan eşdeğerlik sonucu çıkarılmamaktadır.}
\end{table}
