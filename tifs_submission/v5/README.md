...
- `manuscript/main.tex`, `main.pdf`: ana makale, 11 sayfa, özet 250 kelime (V5, 26 Eylül 2026; değişiklikler [CHANGES_V5.md](CHANGES_V5.md) içinde).
- `manuscript/supplement.tex`, `supplement.pdf`: ek belge, 6 sayfa.
