...
\caption{\method{} yönteminin karar yolu. (a) Aşama~1 geometrik medyan çevresinde ilk havuz $B_0$'ı oluşturur; Aşama~2 küme aşamasını göreli yoğunluk boşluğu Aşama-1 retleriyle birlikte görüldüğünde açar ve üç turluk bir bellek onu açık tutabilir; Aşama~3 düşük yoğunluklu kümeyi kümeler ve merkezi $B_0$'ın geometrik medyanından $\tau R_0$'dan daha uzak olan grupları reddeder. Son küme her zaman $B\subseteq B_0$ koşulunu sağlar. (b) Kullanılan aşama fonksiyonlarının sentetik noktalar üzerinde ürettiği açıklayıcı iki boyutlu örnek (deney verisi değildir). Aşama~1 saldırganları dokuz dürüst noktayla birlikte dışlar; Aşama~3'ün reddettiği iki grubun tamamı $B_0$ dışında kaldığından küme aşaması kabul kümesini değiştirmez. Örnek yalnızca işleyişi gösterir: Bölüm~\ref{sec:mechanism}'de incelenen kayıtlı saldırılı kontrol noktalarının hepsinde $B_0$, saldırganlar dahil bütün katılımcıları içerir; aynı bölüm her aşamanın ne sıklıkla çalıştığını raporlar.}
\label{fig:pipeline}
\end{figure*}
...
Bu bölüm, Aşama~1'in üzerindeki aşamaların neden bu kadar az şey değiştirdiğini soruyor. Üç gözlem bu soruyu yanıtlar. Küme aşaması nadiren çalışır: kullanılan kapı altında 36 saldırılı kontrol noktasının hiçbirinde çalışmaz. Çalışmaya zorlandığında, Önerme~\ref{prop:vacuity}'ün yeter koşulu bu 36 kontrol noktasının 35'inde sağlanır; yani aşama hiçbir grubu reddedemez. Test etmeden bıraktığı güncellemeleri tekil olarak test etmek dürüst ret ekler, ancak saldırgan reddi eklemez.

Kanonik koşumlar güncelleme matrislerini saklamadığından yeniden oynatma, komşuluk kesmesini inceleyen ayrı bir çalışmadaki 24 Fed-MDBSCAN-G koşumundan alınan 72 matrisi kullanır: MNIST ve Fashion-MNIST, üç tohum ve 18'er matrislik dört blok, yani $\alpha=0.01$'de Min-Max ve $\alpha=0.1$'de yama saldırısı ile her birinin saldırısı kapatılmış kontrolü. Bu koşumlar yerel eğitimi turda beş optimizasyon adımıyla sınırlar, PyTorch'un deterministik kipini açar; saldırılı olanlarda 90 katılımcı arasında 27 yerine 18 saldırgan vardır. Bunların dışında kanonik protokolü izlerler. Yeniden yürütülen her koşum, özgün tur kayıtlarının zamanlama dışındaki bütün alanlarıyla 30 turun hepsinde eşleşmiş ve güncellemeleri 0, 9 ve 29. turlarda kaydedilmiştir. Her matris iki kapı ayarı ve iki komşuluk kesmesi seçeneği altında değerlendirilir.
